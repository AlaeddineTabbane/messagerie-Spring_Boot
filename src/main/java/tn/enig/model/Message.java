...
public class Message {
	...
	@ManyToOne @JoinColumn(name="send_id")
	private Utilisateur usersend;
	
	@ManyToOne @JoinColumn(name="receive_id")
	...
	public Message(String sujet, String contenu, Utilisateur usersend, Utilisateur userreceive) {
		super();
		this.sujet = sujet;
		this.contenu = contenu;
		this.usersend = usersend;
